...
To create a Watson Machine Learning instance, navigate back to your [IBM Cloud Dashboard](https://console.bluemix.net/dashboard/apps/?cm_mmc=objectdetectiontensorflowjs) and click the **Create resource** button.
